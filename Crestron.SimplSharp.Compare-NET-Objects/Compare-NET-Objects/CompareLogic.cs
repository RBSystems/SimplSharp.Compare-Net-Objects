...
namespace KellermanSoftware.CompareNetObjects
{
    ...
    public class CompareLogic : ICompareLogic
    {
        ...
        {
            Config.MembersToIgnore = new List<string>(); /*Settings.Default.MembersToIgnore == null
                                ? new List<string>()
			...
			Config.CompareStaticFields = true; //Settings.Default.CompareStaticFields;
	        Config.CompareStaticProperties = true; //Settings.Default.CompareStaticProperties;

	        Config.ComparePrivateProperties = false; //Settings.Default.ComparePrivateProperties;
	        Config.ComparePrivateFields = false; //Settings.Default.ComparePrivateFields;

	        Config.CompareChildren = true; //Settings.Default.CompareChildren;
	        Config.CompareReadOnly = true; //Settings.Default.CompareReadOnly;
			Config.CompareFields = true; //Settings.Default.CompareFields;
	        Config.IgnoreCollectionOrder = true; //Settings.Default.IgnoreCollectionOrder;
	        Config.CompareProperties = true; //Settings.Default.CompareProperties;
	        Config.Caching = true; //Settings.Default.Caching;
	        Config.AutoClearCache = true; //Settings.Default.AutoClearCache;
	        Config.MaxDifferences = 2; //Settings.Default.MaxDifferences;
	        Config.IgnoreUnknownObjectTypes = false; //Settings.Default.IgnoreUnknownObjectTypes;
	        Config.IgnoreObjectDisposedException = false; //Settings.Default.IgnoreObjectDisposedException;
        }
#endif
